...
@section('main')
    <div class="bg-custom-vert">
        ...
        <div class="container mx-auto p-8">
            ...
            <form method="post" action="{{ route('cabanes.store') }}" class="bg-white p-8 rounded-xl shadow-lg mb-8">
                @csrf
                <div class="mb-4">
                    <label for="nomCabane" class="block text-lg font-medium mb-2 text-gray-700">Nom de la cabane</label>
                    <input id="nomCabane" name="nomCabane" placeholder="Ajoutez un nom de cabane..."
                        class="w-full p-3 border border-gray-300 rounded-md focus:ring-2 focus:ring-custom-marron focus:border-custom-marron"
                        required />
                </div>
                <div class="mb-4">
                    <label for="description" class="block text-lg font-medium mb-2 text-gray-700">Description</label>
                    <textarea id="description" name="description" placeholder="Ajoutez une description..."
                        class="w-full p-3 border border-gray-300 rounded-md focus:ring-2 focus:ring-custom-marron focus:border-custom-marron"></textarea>
                </div>
                <div class="mb-4">
                ...
                <div class="mb-4">
                    ...
                    <input id="prix" name="prix" placeholder="Ajoutez un prix..."
                        class="w-full p-3 border border-gray-300 rounded-md focus:ring-2 focus:ring-custom-marron focus:border-custom-marron"
                        required />
                </div>
                <div class="mb-4">
                ...
                <div class="flex justify-end">
                    <button type="submit"
                        class="bg-custom-marron text-white px-6 py-3 rounded-md shadow-md">Ajouter</button>
                </div>
            </form>
                ...
                <tbody class="text-gray-700">
                    @foreach ($cabanes as $cabane)
                        <tr class="border-b hover:bg-gray-50">
                            ...
                            <td class="py-4 px-6 text-center"><a href="{{ route('editerCabane', $cabane->id) }}"
                                    class="text-blue-500 hover:text-blue-700 transition"><i
                                        class="fa-solid fa-pencil"></i></a></td>
                            <td class="py-4 px-6 text-center"><a href="{{ route('supprimerCabane', $cabane->id) }}"
                                    class="text-red-500 hover:text-red-700 transition"><i class="fa-solid fa-trash"></i></a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
