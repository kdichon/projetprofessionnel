<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8 flex flex-col space-y-8 ">
            <a href="{{ route('cabanes.index') }}"
                class=" flex items-center justify-between bg-white  border-2 border-custom-marron dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
            ...
            <a href="https://mail.google.com/mail/u/3/?ogbl#inbox" target="_blank"
                class=" flex items-center justify-between bg-white  border-2 border-custom-marron dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-custom-marron dark:text-gray-100 flex space-x-4">
